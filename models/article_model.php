	...
	*/	
	class ArticleModel extends Model {
		...
		*/
		...
		/**
		* Méthode permettant de récupérer les articles en fonction de filtres 
		* @param int $intLimit nombre d'articles maximum à afficher, par défaut 0 = tous
		* @param array $arrSearch Tableau des éléments de Recherche
		* @return array Tableau de tableau des articles
		*/
		public function findAll(int $intLimit = 0, array $arrSearch = array()){
